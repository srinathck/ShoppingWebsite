...
namespace ShoppingWebSite.Controllers
{
    ...
    public class ProductTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,QuantityAvail,imagesrc,Category")] ProductTable productTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Price,QuantityAvail,imagesrc,Category")] ProductTable productTable)
        {
            if (ModelState.IsValid)
            {
